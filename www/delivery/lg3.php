...
$aArr[$name] = urldecode($value);
					...
					function MAX_Delivery_log_getArrGetVariable2($name)
					{
						$varName = $GLOBALS['_MAX']['CONF']['var'][$name];
						return isset($_GET[$varName]) ? explode(',', $_GET[$varName]) : array();
					}
					function MAX_Delivery_log_getArrGetVariable3($orig)
					{
						return isset($orig) ? explode('|', $orig) : array();
					}
...
MAX_cookieAdd($conf['var']['viewerId'], $viewerId, _getTimeYearFromNow());
					...
					$aAdIds2 = MAX_Delivery_log_getArrGetVariable2('adId');
					$aCampaignIds2 = MAX_Delivery_log_getArrGetVariable2('campaignId');
					$aCreativeIds2 = MAX_Delivery_log_getArrGetVariable2('creativeId');
					$aZoneIds2 = MAX_Delivery_log_getArrGetVariable2('zoneId');
					$aCapAd2['block'] = MAX_Delivery_log_getArrGetVariable2('blockAd');
					$aCapAd2['capping'] = MAX_Delivery_log_getArrGetVariable2('capAd');
					$aCapAd2['session_capping'] = MAX_Delivery_log_getArrGetVariable2('sessionCapAd');
					$aCapCampaign2['block'] = MAX_Delivery_log_getArrGetVariable2('blockCampaign');
					$aCapCampaign2['capping'] = MAX_Delivery_log_getArrGetVariable2('capCampaign');
					$aCapCampaign2['session_capping'] = MAX_Delivery_log_getArrGetVariable2('sessionCapCampaign');
					$aCapZone2['block'] = MAX_Delivery_log_getArrGetVariable2('blockZone');
					$aCapZone2['capping'] = MAX_Delivery_log_getArrGetVariable2('capZone');
					$aCapZone2['session_capping'] = MAX_Delivery_log_getArrGetVariable2('sessionCapZone');
					$aSetLastSeen2 = MAX_Delivery_log_getArrGetVariable2('lastView');
					
					$countAdIds2 = count($aAdIds2);
					for ($index2 = 0 ;$index2 <$countAdIds2 ; $index2++) {
						//echo("<hr />");
						$aAdIds = MAX_Delivery_log_getArrGetVariable3($aAdIds2[$index2]);
					$aCampaignIds = MAX_Delivery_log_getArrGetVariable3($aCampaignIds2[$index2]);
					$aCreativeIds = MAX_Delivery_log_getArrGetVariable3($aCreativeIds2[$index2]);
					$aZoneIds = MAX_Delivery_log_getArrGetVariable3($aZoneIds2[$index2]);
					$aCapAd['block'] = MAX_Delivery_log_getArrGetVariable3($aCapAd2['block'][$index2]);
					$aCapAd['capping'] = MAX_Delivery_log_getArrGetVariable3($aCapAd2['capping'][$index2]);
					$aCapAd['session_capping'] = MAX_Delivery_log_getArrGetVariable3($aCapAd2['session_capping'][$index2]);
					$aCapCampaign['block'] = MAX_Delivery_log_getArrGetVariable3($aCapCampaign2['block'][$index2]);
					$aCapCampaign['capping'] = MAX_Delivery_log_getArrGetVariable3($aCapCampaign2['capping'][$index2]);
					$aCapCampaign['session_capping'] = MAX_Delivery_log_getArrGetVariable3($aCapCampaign2['session_capping'][$index2]);
					$aCapZone['block'] = MAX_Delivery_log_getArrGetVariable3($aCapZone2['block'][$index2]);
					$aCapZone['capping'] = MAX_Delivery_log_getArrGetVariable3($aCapZone2['capping'][$index2]);
					$aCapZone['session_capping'] = MAX_Delivery_log_getArrGetVariable3($aCapZone2['session_capping'][$index2]);
					$aSetLastSeen = MAX_Delivery_log_getArrGetVariable3($aSetLastSeen2[$index2]);
					$countAdIds = count($aAdIds);
						...
						if ($aAdIds[$index] >= -1) {
$GLOBALS['_MAX']['deliveryData']['Plugin_deliveryDataPrepare_oxDeliveryDataPrepare_dataCommon']=''; 
							$adId = $aAdIds[$index];
							if ($GLOBALS['_MAX']['CONF']['logging']['adImpressions']) {
								MAX_Delivery_log_logAdImpression($adId, $aZoneIds[$index]);
//print_r($aAdIds[$index]);echo "| ";
							}
